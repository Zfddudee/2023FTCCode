...
public class AutoCycleRight extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence TrajectoryOut = drive.trajectorySequenceBuilder(startPose)
                ...
                .UNSTABLE_addTemporalMarkerOffset(-0.5, () -> bertha.AutoExtakeLeft(Constants.IntakeFlips1))
...
//            bertha.AutoExtakeLeft();
            bertha.AutoIntakeFromLift(Constants.IntakeFlips1, Constants.IntakeOutAuto1);
            bertha.AutoExtakeLeft(Constants.IntakeFlips2);
            bertha.AutoIntakeFromLift(Constants.IntakeFlips2, Constants.IntakeOutAuto2);
            bertha.AutoExtakeLeft(Constants.IntakeFlips3);
